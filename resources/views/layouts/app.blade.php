        ...
        <div class="w-70 mr-5">
            ...
            style="
                ...
                <div class="text-center px-6 py-2 pt-6">
                    ...
                    <p class="text-xs mt-4">Let is know wha you would like and we'll take a look over!</p>
                </div>
                <form action="#" method="POST" class="space-y-4 px-4 py-6">
                    <div>
                        <input type="text" class="w-full text-sm bg-gray-100 rounded-xl border-none
                        placeholder-gray-900 px-4 py-2" placeholder="Your idea" />
                    </div>
                    <div>
                        <select name="category_add" id="category_add" class="w-full border-none rounded-xl
                    ...
                    <div>
                        <textarea  name="idea" id="idea" cols="30" rows="4" class="w-full bg-gray-100
                        rounded-xl border-none placeholder-gray-900 text-sm px-4 py-2"></textarea>
                    </div>
