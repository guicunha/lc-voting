    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div class="relative">
                ...
                <div class="hidden absolute z-10 w-104 text-left font-semibold text-sm bg-white
            ...
            <div class="relative">
                ...
                <div class="absolute z-20 w-76 text-left font-semibold text-sm bg-white
                shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class="bg-gray-200 border-none text-red"
                                           checked="" name="radio-direct" value="Cloed">
